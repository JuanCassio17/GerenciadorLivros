...
public class MainActivity extends AppCompatActivity implements LivroAdapter.OnLivroListener, DeleteDialog.OnDeleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*listaLivros.add(new Livro(1L,"Android para Leigos","Michael Burton","Alta books",1));
        listaLivros.add(new Livro(2L,"Android para Programadores","Paul J, Deitel","Bookman",0));
